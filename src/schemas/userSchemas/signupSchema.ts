...
const usernameSchema = z.string().max(20, "Username must be 20 characters or less").min(8, "Username must be atleast 8 characters").regex(/^[a-zA-Z0-9_]+$/, "Username must not contain special characters")
...
export { signupSchema, usernameSchema }